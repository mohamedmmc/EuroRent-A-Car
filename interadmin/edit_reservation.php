      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="gestionreservation.php">Gestion des réservations</a>
...
if (isset($_POST['update'])) {
  ...
  $query = "UPDATE reservation set client = '$client',voiture = '$voiture',depart ='$depart',retour = '$retour',livraison = '$livraison',chauffeur='$chauffeur',  etat = '$etat', prix = '$prix',paiement = '$paiement'  WHERE id=$id";
  $result = mysqli_query($conn, $query);
  if($result) {
    echo "<script type = \"text/javascript\">
    alert(\"Modification effectué avec succés\");
    window.location = (\"gestionreservation_client.php\")
    </script>";
}
  ...
  <div class="row">
    <div class="col-md-4 mx-auto">
      ...
      <div class="form-group">
          <a1>ID réservation : </a1>
          <output  type="text" name="id" class="form-control" placeholder="ID reser"> <?php echo $id; ?> </output>
          </div>
        <div class="form-group">
          <a1>ID Client : </a1>
          <output  type="text" name="client" class="form-control" ><?php echo $client; ?></output>
          <input type="hidden" name="client" class="form-control" value="<?php echo $client; ?>" placeholder="ID client">
          </div>
          <div class="form-group">
          <a1>ID voiture : </a1>
          <output type="text" name="voiture" class="form-control"> <?php echo $voiture; ?> </output>
          <input type="hidden" name="voiture" class="form-control" value="<?php echo $voiture; ?>" placeholder="voiture">

          </div>
          <div class="form-group">
            <a1>Départ : </a1>
            <output name="depart" > <?php echo $depart; ?> </output>
            <input type="hidden" name="depart" value="<?php echo $depart; ?> "> 

          </div>
          <div class="form-group">
          <a1>Retour : </a1>
          <output  name="retour"  > <?php echo $retour; ?> </output>
          ...
          <div class="form-group">
          <a1>Chauffeur : </a1>
          <select type="hidden" name="chauffeur" class="form-control" value="<?php echo $chauffeur; ?>" placeholder="Chauffeur">
          ...
          <div class="form-group">
          <a1>Prix : </a1>
            <input type="text" name="prix" class="form-control" value="<?php echo $prix; ?>" placeholder="Prix">
          </div>
          <div class="form-row">
                    <div class="col-lg-12">
                        ...
                        <h4>Paiement :</h5><br>
                        <?php echo $paiement; ?>
                            <input type="hidden" id="paypal" name="paiement" value="<?php echo $paiement; ?>">
                            <br>
                            <input type="hidden" id="carte" name="paiement" value="<?php echo $paiement; ?>">
                           <br>
                            <input type="hidden" id="agence" name="paiement" value="<?php echo $paiement; ?>">
