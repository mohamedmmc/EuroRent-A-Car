...
<main class="container p-4">
  <div class="row">
    <div class="card card-body">
      ...
      <!-- ADD TASK FORM -->
     <!-- <div class="card card-body">
        <form action="sauvgarder_client.php" method="POST">
        ...
        <div class="form-group">
            <input type="text" name="adresse" minlength="1" required oninvalid="setCustomValidity('adresse doit etre non vide')" oninput="setCustomValidity('')" class="form-control" placeholder="Adresse" autofocus>
          </div>
          <div class="form-group">
            <input type="text" name="numdetel" class="form-control" maxlength="8" pattern="[0-9]{8,}"  required oninvalid="setCustomValidity('le numero de telephone doit contenir  8 chiffres')" oninput="setCustomValidity('')" placeholder="numero de téléphone" autofocus>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <input type="text" name="role" minlength="1" value="client" required oninvalid="setCustomValidity('Le role doit étre client')" oninput="setCustomValidity('')" class="form-control" placeholder="Role" autofocus>
          </div>
   ...
   $acin= $_GET['acin'];
     ...
     $query = "SELECT * FROM user where rolee='client' order by id asc";}   
          ...
          <tr>
            ...
            <td><?php echo $row['rolee']; ?></td>
            <td>
              <!--<a href="modifier_client.php?id=<?php echo $row['id']?>" class="btn btn-secondary">
                <i class="fas fa-marker"></i>
              </a>-->
              <a href="supprimer_client.php?id=<?php echo $row['id']?>" class="btn btn-danger">
