          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="../accueil.html" data-toggle="modal" data-target="#logoutModal">
...
if  (isset($_GET['id'])) {
  $id = $_GET['id'];
  $query = "SELECT * FROM chauffeur WHERE id=$id";
...
if (isset($_POST['update'])) {
  ...
  $query = "UPDATE chauffeur set nom = '$nom', prenom = '$prenom',cin = '$cin',numtel ='$numtel', disponibilite = '$disponibilite' WHERE id=$id";
  $result = mysqli_query($conn, $query);
  if($result) {
  $_SESSION['message'] = 'Chauffeur modifié avec succés';
  ...
  echo "<script type = \"text/javascript\">
    ...
    else
    {
       echo "<script type = \"text/javascript\">
    alert(\"nn\");
    window.location = (\"modifchauf.php\")
    </script>";
    }
}
?>
...
<div class="container p-4">
  <div class="row">
    <div class="col-md-4 mx-auto">
      ...
      <form action="modifchauf.php?id=<?php echo $_GET['id']; ?>" method="POST">
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
          <a1>CIN : </a1>
          <input type="text" name="cin" class="form-control" value="<?php echo $cin; ?>" placeholder="CIN">
          </div>
          <div class="form-group">
          <a1>Numéro de téléphone : </a1>
          <input type="text" name="numtel" class="form-control" value="<?php echo $numtel; ?>" placeholder="Numéro de téléphone">

          <div class="form-group">
            Disponibilite :
           <select class="form-control" placeholder="etat" name="disponibilite">
            <option>dispo</option>
            <option>nn dispo</option>
          </select>
        </div>
