          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="https://www.champcueil.fr/wp-content/uploads/2019/07/agent.png">
              </a>
      ...
      <div class="card card-body">
        <form action="save_reservation.php" method="POST">
          ...
          <a1>ID réservation : </a1>
            <input type="text" name="reservation" class="form-control" placeholder="ID Réservation" autofocus>
          </div>
          <div class="form-group">
          <a1>ID Client : </a1>
          <input type="text" name="client" class="form-control" placeholder="ID Client" autofocus>
          </div>
          <div class="form-group">
          <a1>ID voiture : </a1>
          <input type="text" name="voiture" class="form-control" placeholder="ID Voiture" autofocus>
          </div>
          <div class="form-group">
            <a1>Départ : </a1>
          <input id="datetime" type="text" class="form-control" placeholder="Date départ"  name="depart" min="2018-01-01" max="2020-12-12" autofocus>
          </div>
          <div class="form-group">
          <a1>Retour : </a1>
          <input id="datetime2"  type="text"  class="form-control" placeholder="Date retour" name="retour"  min="2018-01-01" max="2020-12-12" autofocus>
          </div>
          <div class="form-group">
          <a1>Livraison : </a1>
          <select name="livraison" class="form-control" autofocus >
          ...
          <div class="form-group">
          <a1>Etat : </a1>
          <select name="etat" class="form-control" autofocus >
          ...
          <input type="submit" name="save_reservation" class="btn btn-success btn-block" value="Enregistrer">
        </form>
      </div>
    </div>
    <div class="col-md-8">
