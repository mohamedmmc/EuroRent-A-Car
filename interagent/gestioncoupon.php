      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item " href="gestionreservation.php">Gestion des commandes</a>
            ...
            <a class="collapse-item active" href="gestioncoupon.php">Gestion des coupons</a>
          </div>
        </div>
      </li>
...
?></span>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Gestion des coupons</h1>
          <center>
        ...
        <form action="save_coupon.php" method="POST">
          <div class="form-group">
            ...
            <input type="text" pattern="\d*" maxlength="4"  name="codepromo" class="form-control" placeholder="code promo"     required oninvalid="setCustomValidity('le code doit contenir 4 chiffres ')" oninput="setCustomValidity('')" autofocus>
                    ...
                    <div class="form-group">
                      <input type="number" name="prix" class="form-control" placeholder="prix" required pattern="\d{4}-\d{2}-\d{2}"  required oninvalid="setCustomValidity('veuillez saisir un prix valide')" oninput="setCustomValidity('')" autofocus>
                    </div>
                    
                    <div class="form-group">
                      <input type="email" name="mail" class="form-control" placeholder="email"  required oninvalid="setCustomValidity('Le mail doit etre non vide')" oninput="setCustomValidity('')"  autofocus>
                    
                    </div>
                    <div class="form-group">
                    <input type="text" pattern="\d*" maxlength="2"  name="pourcentage" class="form-control" required placeholder="pourcentage de la promotion "     >
                                        </div>

          <input type="submit" name="save_task" class="btn btn-success btn-block" value="ajouter coupon">
        </form>
</div>
      </div>
...
{   
 if (empty($_GET['acode'])){
   ...
   $query = "SELECT * FROM coupon  order by pourcentage asc";
 }
 else {
 $acode= $_GET['acode'];
   ...
   $query = "SELECT * FROM coupon order by pourcentage asc";}   
          ...
          <tr>
            ...
            <td>
              <a href="edit_coupon.php?codepromo=<?php echo $row['codepromo']?>" class="btn btn-secondary">
                <i class="fas fa-marker"></i>
              </a>
              <a href="delete_coupon.php?codepromo=<?php echo $row['codepromo']?>" class="btn btn-danger">
      ...
      <form action="stat.php" method="POST">
        ...
        <center>  <input type="submit" name="stat" class="btn btn-success btn-block" value="statisique" style="width:325px">
        </form>
    </div>
  </div>
</main>
