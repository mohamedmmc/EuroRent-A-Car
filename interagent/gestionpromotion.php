      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="gestionpromotion.php">Gestion des promotions </a>
      ...
      <div class="card card-body">
        <form action="save_promotion.php" method="POST">
          <div class="form-group">
            ...
            <input  type="text" pattern="\d*" maxlength="4"name="codepromo" class="form-control" placeholder="code promo"     required oninvalid="setCustomValidity('le code doit contenir 4 chiffres ')" oninput="setCustomValidity('')" autofocus>
                    </div>
                    <div class="form-group">
                      <input autocomplete="off" id="datetime" type="text" name="dated" class="form-control" placeholder="Date de debut"   required oninvalid="setCustomValidity('veuillez saisir une date de debut valide')" oninput="setCustomValidity('')" autofocus>
                    </div>
                    <div class="form-group">
                      <input autocomplete="off"  id="datetime2" type="text" name="datef" class="form-control" placeholder=" date fin"  required oninvalid="setCustomValidity('veuillez saisir une date de fin valide')" oninput="setCustomValidity('')" autofocus>
                    </div>
                    <div class="form-group">
                      <input type="text" pattern="\d*" maxlength="2" name="prixp" class="form-control" placeholder="pourcentage"  required oninvalid="setCustomValidity('Le motif doit etre non vide')" oninput="setCustomValidity('')"  autofocus>
                    
                    </div>
                    <div class="form-group">
                    <input  type="text" name="marquep" class="form-control" placeholder="marque de voiture de la promotion " required    >
                                        </div>
    ...
    <div class="col-md-8">
      <table class="table table-bordered">
        <thead>
          ...
          <th>date debut de la promotion </th>
          <th>date fin de la promotion</th>
                    <th>pourcentage de la promotion</th>
                    <th>marque de la promotion </th>
...
{   
 ...
 $acode= $_GET['acode'];
        $query = "SELECT * FROM promotion where codepromo=$acode ";}}
else {
   ...
   $query = "SELECT * FROM promotion order by datef asc";}   
          ...
          <tr>
            ...
            <td>
              <a href="edit_promotion.php?codepromo=<?php echo $row['codepromo']?>" class="btn btn-secondary">
                <i class="fas fa-marker"></i>
              </a>
              <a href="delete_promotion.php?codepromo=<?php echo $row['codepromo']?>" class="btn btn-danger">
