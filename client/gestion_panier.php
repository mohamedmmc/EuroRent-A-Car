...
<table class="table table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="edit_reservation.php?id=<?php echo $row['id']?>" class="btn btn-secondary">
          <a>Modifier </a>
        </a>
    </td>
    <td>
        <a href="delete_reservation.php?id=<?php echo $row['id']?>" class="btn btn-danger">
        <a>Supprimer </a>
        </a></td>
    ...
    <?php } ?>
        ...
        <div>
            <a type="button" href="confirmation.php" class="btn btn-secondary btn-lg"> Passer la commande  </a> 
        </div>
        <br>
    </div>
