            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="page-breadcrumb">
                        <h2><span></span>Gestion des réservations</h2>
     ...
     <div class="form-row">
                    <div class="col-lg-12">
                        ...
                        <h4>Paiement :</h5><br>
                            ...
                            <label for="paypal">Paypal <img src="../img/paypal.jpg" alt=""></label>
                            <input type="radio" id="paypal" name="paiement" value="paypal">
                            <br>
                            <label for="carte">Carte bancaire <img src="../img/mastercard.jpg" alt=""> </label>
                            <input type="radio" id="carte" name="paiement" value="carte">

                           <br>
                           <label for="agence">Payez sur place</label>
                            <input type="radio" id="agence" name="paiement" value="agence">
        ...
        <div>
            <input type="submit" name="save_commande" class="btn btn-secondary btn-lg" value="Payer" autofocus> 
        </div>
         </form>
        <br>
         <form  method="post" >
